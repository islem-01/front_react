...
import iitBlanc from "../../assets/iit_blanc.png";
import schoolIIT from "../../assets/schoolIIT.png";
import "./Sidebar.css";
...
const navItems = [
  ...
  },
  {
    ...
    icon: <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.8" strokeLinecap="round" strokeLinejoin="round"><path d="M12 4a4 4 0 100 8 4 4 0 000-8z"/><path d="M20 21v-2a4 4 0 00-4-4H8a4 4 0 00-4 4v2"/><path d="M15 7h6M18 4v6"/></svg>,
  },
  {
  ...
  {
    id: "affectation", label: "Affectation des places",
    icon: <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.8" strokeLinecap="round" strokeLinejoin="round"><path d="M20 7h-4.18A3 3 0 0016 5.18V4a2 2 0 00-2-2H6a2 2 0 00-2 2v12a2 2 0 002 2h12a2 2 0 002-2V9a2 2 0 00-2-2z"/><path d="M16 2v4h4"/><line x1="8" y1="12" x2="16" y2="12"/><line x1="8" y1="16" x2="16" y2="16"/><line x1="8" y1="8" x2="10" y2="8"/></svg>,
  },

  {
    id: "alertes", label: "Alertes IA",
    icon: <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.8" strokeLinecap="round" strokeLinejoin="round"><path d="M18 8A6 6 0 006 8c0 7-3 9-3 9h18s-3-2-3-9"/><path d="M13.73 21a2 2 0 01-3.46 0"/></svg>,
  },
  {
  ...
  return (
    <aside className="sidebar">
      <div className="sidebar-brand">
        <img src={iitBlanc} alt="IIT" className="sidebar-brand-logo"/>
        <div className="sidebar-brand-text">
          <span className="sidebar-brand-name">Smart Exam</span>
      ...
      <div className="sidebar-institute">
        <div className="sidebar-institute-content">
          ...
          <div className="institute-info">
            <span className="institute-name">IIT</span>
            <span className="institute-full">Institut Universitaire<br/>de Technologie</span>
          </div>
        </div>
        <img src={schoolIIT} alt="Campus IIT" className="sidebar-campus-img"/>
      </div>
